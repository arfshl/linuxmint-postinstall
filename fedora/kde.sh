...
sudo dnf install vlc systemd-resolved curl cabextract xorg-x11-font-utils fontconfig kamoso firefox plasma-discover thunderbird kcalc gwenview -y
...
cp /usr/share/applications/org.kde.konsole.desktop $HOME/Desktop/org.kde.konsole.desktop
...
# Done Process
echo "Welcome, Your Fedora KDE is now ready for daily usage as Windows, but with less annoying and more private"
