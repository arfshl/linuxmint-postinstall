...
sudo dnf install vlc systemd-resolved curl cabextract xorg-x11-font-utils fontconfig cheese thunderbird firefox dnfdragora gnome-software galculator -y
sudo dnf install -y https://downloads.sourceforge.net/project/mscorefonts2/rpms/msttcore-fonts-installer-2.6-1.noarch.rpm
cp /usr/share/applications/vlc.desktop $HOME/Desktop/vlc.desktop
cp /usr/share/applications/gpicview.desktop $HOME/Desktop/gpicview.desktop
...
cp /usr/share/applications/pcmanfm.desktop $HOME/Desktop/pcmanfm.desktop
cp /usr/share/applications/lxterminal.desktop $HOME/Desktop/lxterminal.desktop
cp /usr/share/applications/galculator.desktop $HOME/Desktop/galculator.desktop
...
# Done Process
echo "Welcome, Your Fedora LXDE is now ready for daily usage as Windows, but with less annoying and more private"
