...
sudo dnf install vlc systemd-resolved curl cabextract xorg-x11-font-utils fontconfig kamoso firefox plasma-discover thunderbird kcalc lximage-qt -y
...
# Done Process
echo "Welcome, Your Fedora LXQt is now ready for daily usage as Windows, but with less annoying and more private"
